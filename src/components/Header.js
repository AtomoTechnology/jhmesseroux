      ...
      <div className="wrapper text-white gap-12 grid-cols-1 grid sm:grid-cols-2 items-center justify-around p-4  ">
        <div className="about-me flex flex-col gap-4 ">
          ...
          <p className="description">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita quam quae eum perferendis sunt fuga fugit!
            Commodi quod sed pariatur laudantium veniam, atque cum aperiam nulla impedit. Natus, minima doloremque?
          </p>
